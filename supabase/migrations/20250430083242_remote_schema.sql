...
CREATE TABLE IF NOT EXISTS "images"."images" (
    ...
    "processedimageid" "uuid"
);


ALTER TABLE "images"."images" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "images"."metadata" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
...
ALTER TABLE "images"."metadata" OWNER TO "postgres";
...
ALTER TABLE ONLY "images"."images"
    ADD CONSTRAINT "images_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "images"."images"
    ADD CONSTRAINT "images_processedimageid_key" UNIQUE ("processedimageid");



ALTER TABLE ONLY "images"."metadata"
...
CREATE INDEX "idx_images_metadataid" ON "images"."images" USING "btree" ("metadataid");



CREATE INDEX "idx_images_objectid" ON "images"."images" USING "btree" ("objectid");



CREATE INDEX "idx_metadata_imageid" ON "images"."metadata" USING "btree" ("imageid");
...
ALTER TABLE ONLY "images"."images"
    ADD CONSTRAINT "images_metadataid_fkey" FOREIGN KEY ("metadataid") REFERENCES "images"."metadata"("id");



ALTER TABLE ONLY "images"."images"
    ADD CONSTRAINT "images_objectid_fkey" FOREIGN KEY ("objectid") REFERENCES "storage"."objects"("id");
...
ALTER TABLE "images"."images" ENABLE ROW LEVEL SECURITY;


ALTER TABLE "images"."metadata" ENABLE ROW LEVEL SECURITY;
...
ALTER TABLE "public"."model_version_tags" ENABLE ROW LEVEL SECURITY;
...
ALTER TABLE "public"."registered_model_aliases" ENABLE ROW LEVEL SECURITY;


ALTER TABLE "public"."registered_model_tags" ENABLE ROW LEVEL SECURITY;
...
CREATE POLICY "select_metrics" ON "public"."metrics" FOR SELECT USING (true);
...
ALTER TABLE "public"."trace_info" ENABLE ROW LEVEL SECURITY;


ALTER TABLE "public"."trace_request_metadata" ENABLE ROW LEVEL SECURITY;
