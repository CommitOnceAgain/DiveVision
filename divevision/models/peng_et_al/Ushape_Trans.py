...
class Generator(nn.Module):
    ...
    def __init__(
        ...
        if self.conv_patch_representation:
            ...
            self.Conv_x = nn.Conv2d(
                256, self.embedding_dim, kernel_size=3, stride=1, padding=1  # 512
            )
        ...
        self.feature_to_rgb = ModuleList(
            [to_rgb(32), to_rgb(64), to_rgb(128), to_rgb(256)]
        )
        ...
        self.mtc = ChannelTransformer(
            channel_num=[32, 64, 128, 256], patchSize=[32, 16, 8, 4]
        )
    ...
    def forward(self, x):
        ...
        e5 = e5.view(
            e5.size(0), -1, self.embedding_dim
        )  # B,16,16,512->B,16*16,512 线性映射层
