...
class conv_block(nn.Module):
    ...
    def __init__(self, in_ch, out_ch, use_eql=True):
        ...
        if use_eql:
            self.conv_1 = _equalized_conv2d(in_ch, out_ch, (1, 1), pad=0, bias=True)
            self.conv_2 = _equalized_conv2d(out_ch, out_ch, (3, 3), pad=1, bias=True)
            self.conv_3 = _equalized_conv2d(out_ch, out_ch, (3, 3), pad=1, bias=True)

        else:
            self.conv_1 = Conv2d(in_ch, out_ch, (3, 3), padding=1, bias=True)
            self.conv_2 = Conv2d(out_ch, out_ch, (3, 3), padding=1, bias=True)
    ...
    def __init__(self, in_channels, use_eql=True):
        ...
        if use_eql:
            ...
            self.conv_2 = _equalized_conv2d(
                in_channels, in_channels, (4, 4), stride=2, pad=1, bias=True
            )
